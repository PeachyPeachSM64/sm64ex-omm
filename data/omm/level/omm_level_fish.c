...
static const GeoLayout omm_level_fish_geo[] = {
    ...
    GEO_OPEN_NODE(),
        ...
        GEO_OPEN_NODE(),
            ...
            GEO_OPEN_NODE(),
                ...
                GEO_OPEN_NODE(),
                    GEO_BRANCH(1, castle_geo_001038),
                    GEO_RENDER_OBJ(),
...
static const Collision omm_level_fish_collision[] = {
    COL_INIT(),
    ...
    COL_TRI_INIT(SURFACE_NO_CAM_COLLISION, 1977),
    COL_TRI(181, 182, 183),
    COL_TRI(183, 184, 185),
    COL_TRI(183, 182, 184),
    COL_TRI(181, 186, 182),
...
static void bhv_omm_level_fish_update() {
    ...
    // Bubbles
    if (gGlobalTimer & 1) {
        spawn_object_abs_with_rot(o, 0, MODEL_WHITE_PARTICLE_SMALL, bhvSmallParticleBubbles, 2477, 307, -2000, 0, 0, 0);
    }
    ...
    gOmmSparklyCheats->messageId = OMM_DIALOG_SPARKLY_ANTI_CHEAT_FISH;
    gOmmSparklyCheats->endingId = OMM_DIALOG_SPARKLY_ANTI_CHEAT_END_FISH;
}

static const BehaviorScript bhvOmmLevelFish[] = {
    OBJ_TYPE_SPAWNER,
    BHV_BEGIN_LOOP(),
        BHV_CALL_NATIVE(bhv_omm_level_fish_update),
    BHV_END_LOOP(),
};
...
static const LevelScript omm_level_fish_objects[] = {
    ...
    OBJECT(MODEL_NONE, 4050, 407, -1560, 0, 135, 0, 0x000D0000, bhvDeathWarp),
    OBJECT(MODEL_NONE,    0,   0,     0, 0,   0, 0, 0x00000000, bhvOmmLevelFish),
    RETURN(),
};
...
static const LevelScript omm_level_fish[] = {
    END_AREA(),
    AREA(4, omm_level_fish_geo),
...
LEVEL_CMD_BRANCH(
    level_script_find(level_castle_inside_entry, array_of(LevelScript) { END_AREA() }, 1),
    level_script_find(level_castle_inside_entry, array_of(LevelScript) { AREA(2, 0) }, 1),
    omm_level_fish
);
