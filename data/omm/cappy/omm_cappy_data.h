...
#define OMM_CAPPY_BHV_DEFAULT_GROUND                (0)
#define OMM_CAPPY_BHV_DEFAULT_AIR                   (1)
#define OMM_CAPPY_BHV_UPWARDS_GROUND                (2)
#define OMM_CAPPY_BHV_UPWARDS_AIR                   (3)
#define OMM_CAPPY_BHV_DOWNWARDS_GROUND              (4)
#define OMM_CAPPY_BHV_DOWNWARDS_AIR                 (5)
#define OMM_CAPPY_BHV_SPIN_GROUND                   (6)
#define OMM_CAPPY_BHV_SPIN_AIR                      (7)
#define OMM_CAPPY_BHV_FLYING                        (8)
...
#define OMM_CAPPY_FLAG_RETURNED_TO_MARIO            (1 << 5)

#define OMM_CAPPY_LIFETIME                          (OMM_CHEAT_CAPPY_STAYS_FOREVER ? 0xFFFFFF : 120) // 4 seconds (6 days and a half for CSF cheat)
#define OMM_CAPPY_RETURN_VEL                        (120.f * OMM_CAPPY_MILK_MULTIPLIER(2))
#define OMM_CAPPY_SLOWDOWN_FACTOR                   (1.03f)
#define OMM_CAPPY_SLOWDOWN_POWER                    (0.5f)
...
#define OMM_CAPPY_WALL_ANGLE_STOP                   (0x2000)
...
#define OMM_CAPPY_BHV_DEFAULT_VEL                   (160.f * (1.f + (0.4f * omm_mario_has_vanish_cap(gMarioState))) * omm_player_physics_get_selected_air() * omm_player_physics_get_selected_jump() * OMM_CAPPY_MILK_MULTIPLIER(2))
#define OMM_CAPPY_BHV_DEFAULT_CALL_BACK_START       (8)
#define OMM_CAPPY_BHV_SPIN_OFFSET                   (60.f)
#define OMM_CAPPY_BHV_SPIN_RADIUS_MAX               (240.f * OMM_CAPPY_MILK_MULTIPLIER(2))
#define OMM_CAPPY_BHV_SPIN_RADIUS_GROWTH            (20.f * OMM_CAPPY_MILK_MULTIPLIER(2))
#define OMM_CAPPY_BHV_SPIN_ANGLE_VEL                (0x1000)
#define OMM_CAPPY_BHV_SPIN_CALL_BACK_START          (12)
#define OMM_CAPPY_BHV_UPWARDS_OFFSET                (40.f)
#define OMM_CAPPY_BHV_UPWARDS_VEL                   (89.f * OMM_CAPPY_MILK_MULTIPLIER(2.5f))
#define OMM_CAPPY_BHV_UPWARDS_CALL_BACK_START       (8)
#define OMM_CAPPY_BHV_DOWNWARDS_OFFSET              (40.f)
#define OMM_CAPPY_BHV_DOWNWARDS_VEL                 (111.f * OMM_CAPPY_MILK_MULTIPLIER(2.5f))
#define OMM_CAPPY_BHV_DOWNWARDS_CALL_BACK_START     (8)
...
#define OMM_CAPPY_NUM_STEPS                         (16)

#if OMM_GAME_IS_R96X
#define OMM_CAPPY_MILK_MULTIPLIER(x)                (omm_mario_is_milk(gMarioState) ? (x) : 1.f)
#define OMM_CAPPY_SCALE_MULTIPLIER_X                (omm_mario_is_milk(gMarioState) ? gMarioObject->oScaleX : 1.f)
#define OMM_CAPPY_SCALE_MULTIPLIER_Y                (omm_mario_is_milk(gMarioState) ? gMarioObject->oScaleY : 1.f)
#else
#define OMM_CAPPY_MILK_MULTIPLIER(x)                (1.f)
#define OMM_CAPPY_SCALE_MULTIPLIER_X                (1.f)
#define OMM_CAPPY_SCALE_MULTIPLIER_Y                (1.f)
#endif
