...
#define CELL_SIZE                   0x400   //    1024 //   1024 //    . //
#define NUM_CELLS                   0x40    //      16 //     64 //   x4 //
#define NUM_CELLS_INDEX             0x3F    //      4b //     6b //   +2 //
#define CELL_AMOUNT                 0x40    //      16 //     64 //   x4 //
#define CELL_AMOUNT_MINUS_ONE       0x3F    //      4b //     6b //   +2 //
